...
Export-HardeningLensReport -Path (Join-Path -Path $root -ChildPath 'examples/sample-result.json') -Format Html,Csv -OutputDirectory $OutputDirectory -FileNamePrefix 'sample-report' -Force
