@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'Trust and integrity update with hardened report imports, deterministic drift, isolated catalog objects, complete fleet outcomes, and corrected quality gates.'
        }
    }
}
